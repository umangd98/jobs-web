...
const DiveDeeper = () => {
  return (
    <div className="flex flex-col  p-6  mt-[100px] max-w-[1200px] mx-auto">
      ...
      <form className="w-full space-y-4 ">
        ...
        <div className="flex justify-between">
          <NavLink to="/enterprise_plan" className="mt-4 px-4 py-2 bg-teal-600 text-white rounded-md">Back</NavLink>
          <NavLink to="/job_listing" className="mt-4 px-4 py-2 bg-teal-600 text-white rounded-md">Get started</NavLink>
        </div>
      </form>
      </div>
    </div>
