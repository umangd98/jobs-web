...
const EnterprisePlan = () => {
  return (
    <div className="flex flex-col md:flex-row p-6 bg-white  rounded-lg max-w-[1200px] mx-auto mt-[90px]">
      ...
      <div className="md:w-1/2 p-6  border border-[#0000001c] rounded-xl">
        <form className="space-y-4">
          ...
          <NavLink to="/dive_deeper" type="submit" className=" px-6  py-2 bg-teal-600 text-white rounded-lg lato  w-fit">Next</NavLink>
          </div>
        </form>
      </div>
    </div>
