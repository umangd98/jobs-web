    ...
    <div className="bg-white flex flex-col  items-center justify-center px-4 mb-8">
      <header className="w-full max-w-[1200px] text-primary flex justify-between items-center py-4">
        ...
        <div className="space-x-4">
          <button className="max-sm:px-3 sm:px-4 md:px-5 lg:px-6 sm:py-2 max-md:hidden lg:py-3  border  rounded-[15px] bg-teal-600 text-white">Sign in</button>
          <button className="max-sm:px-3 sm:px-4 md:px-5 lg:px-6 sm:py-2 max-md:hidden lg:py-3  border  rounded-[20px] bg-teal-600 text-white">Schedule a demo</button>
        </div>
      </header>
      <main className="flex flex-col max-sm:w-full max-w-[713px] items-center text-center mt-[160px]">
        ...
        <div className="mt-16 flex max-sm:flex-col gap-y-[20px]  gap-x-[20px]  w-full max-w-md">
          ...
          />
          <NavLink to="/enterprise_plan" className="lg:px-4 px-3 lg:py-3 py-2 bg-teal-600 text-white rounded-[15px] lato hover:bg-teal-700">Get Started</NavLink>
        </div>
      </main>
    </div>
  );
