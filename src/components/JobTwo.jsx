    ...
    <div className="flex flex-col items-center p-6 ">
      <div className=" p-6 rounded-[20px]  w-full  border border-gray-3000">
        ...
        <div className="flex justify-between mt-[150px]">
          <NavLink to="/job_details" className="mt-2 p-2 bg-color-green px-[20px]  text-white rounded-[20px]">Back</NavLink>
          <NavLink to="/senior_product_developer" className="mt-2 p-2 bg-color-green px-[20px]  text-white rounded-[20px]">Add job</NavLink>
        </div>
      </div>
    </div>
  );
