          ...
          <div>
            <nav id="nav" className="lg:text-sm lg:leading-6 relative">
              <div className="color-black flex flex-col items-center py-8 lg:border-r px-1 sm:px-[20px] h-full">
                <div className="rounded-full w-[40px] h-[40px] flex justify-center items-center mx-auto">
                  <img
                ...
                <div className="flex flex-col items-center space-y-8 text-[12px] sm:text-[14px] md:text-[16px] max-sm:mt-[20px] mt-[30px]">
                  <NavLink
                    to="/signin_job_list"
                    className={({ isActive }) =>
                      `flex items-center gap-1 flex-col ${isActive ? "bg-gray-200 p-2 rounded-lg" : ""}`
                    }
                  >
                  ...
                  <NavLink
                    to="/notification"
                    className={({ isActive }) =>
                      `flex items-center gap-1 justify-center flex-col ${isActive ? "bg-gray-200 p-2 rounded-lg" : ""}`
                    }
                  >
                    <img className="w-[25px] h-[25px]" src="/notifications.png" />
