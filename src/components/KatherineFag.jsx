  ...
  return (
    <div className="container mx-auto p-4">
      <header className="flex justify-between items-center py-4">
        <h1 className="text-[36px] font-bold inter color-black">Katherine Feng</h1>
      ...
      <div className="flex max-md:flex-wrap gap-y-[30px] space-x-4 mb-4">
        <button className="px-4 py-2 border  text-color-green rounded-[27px] flex items-center gap-x-[10px]"><span><MdOutlineMail />
        </span> Send Email</button>
        <button className="px-4 py-2 bg-color-green text-white rounded-[27px] flex items-center gap-x-[10px]"><span><IoMdDownload />
        </span> Download Resume</button>
        <button className="px-4 py-2 bg-color-green text-white rounded-[27px] flex items-center gap-x-[10px]"><span><FaExternalLinkAlt />
        </span>Preview LinkedIn</button>
      </div>
      <div className="flex flex-wrap lg:flex-nowrap space-x-4 mb-4">
       ...
       <div className="flex items-center space-x-4 border p-2 shadow-lg w-fit rounded-[30px]">
          ...
          <div className="bg-[#90c4c7] text-gray-700 py-2 px-4 rounded-full mb-4 flex items-center justify-between">View Transcript <span><FaCaretDown /></span></div>
          <div className="bg-white p-4 rounded shadow mb-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h3 className="font-bold mb-2">Custom Questions</h3>
                <p>1) Describe your greatest weakness?</p>
                <p className="text-gray-500">Explanation: "XXX"</p>
                <p>2) What is the most creative thing you've done in a work setting?</p>
                <p className="text-gray-500">Explanation: "XXX"</p>
              </div>
              <div>
        ...
        <div className="w-full lg:w-1/4">
          <div className="bg-white p-4 rounded shadow mb-4">
            ...
            <p>- Best Candidate ever</p>
          </div>
          <div className="bg-white p-4 rounded shadow mb-4">
            <h3 className="text-[18] font-semibold inter text-blak">Top Skills</h3>
            <p>1) Soft Skills</p>
            <p className="text-gray-500">Explanation: "XX"</p>
            <p>2) Analytics</p>
            <p className="text-gray-500">Explanation: "XX"</p>
            <p>3) Python</p>
            <p className="text-gray-500">Explanation: "XX"</p>
